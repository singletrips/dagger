...
for project in "${GRADLE_PROJECTS[@]}"; do
    ...
    ./$project/gradlew -p $project connectedAndroidTest mergeAndroidReports --continue --no-daemon --stacktrace
done
...
./$CONFIG_CACHE_PROJECT/gradlew -p $CONFIG_CACHE_PROJECT connectedAndroidTest mergeAndroidReports --continue --no-daemon --stacktrace --configuration-cache
